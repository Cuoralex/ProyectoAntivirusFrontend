...
export const meta: MetaFunction = () => [
  ...
  {
    name: "description",
    content: "Conoce más sobre nuestra empresa de seguridad informática.",
  },
];
    ...
    <div className="flex flex-col min-h-screen text-gray-900">
      ...
      <div className="flex-grow p-6 max-w-4xl mx-auto text-center">
        ...
        <p className="text-lg text-gray-700 leading-relaxed mb-10">
          Somos una empresa dedicada a la seguridad informática, protegiendo a
          nuestros clientes de amenazas digitales con soluciones innovadoras y
          eficientes. Nuestro equipo está comprometido con la excelencia y la
          mejora continua.
        </p>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-red-500 text-white p-6 rounded-lg shadow-lg text-center">
          ...
          <p className="text-lg">
            Queremos que todos los niños desarrollen su potencial y se
            conviertan en agentes de mejoramiento de su comunidad.
          </p>
        </div>
        ...
        <div className="bg-yellow-500 text-white p-6 rounded-lg shadow-lg text-center">
          ...
          <p className="text-lg">
            Mejorar el acceso y la calidad de la educación inicial con un
            enfoque sistémico (conectando agentes claves) y territorial
            (aproximación local).
          </p>
        </div>
        ...
        <div className="bg-blue-500 text-white p-6 rounded-lg shadow-lg text-center">
          ...
          <p className="text-lg">
            Conectar actores clave para impactar conjuntamente los entornos de
            la primera infancia, mejorando la infraestructura, fortaleciendo
            capacidades y trabajando con la comunidad.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto py-12">
        ...
        >
          <div className="flex flex-col md:flex-row items-center p-6 bg-white rounded-lg shadow-lg">
            <img
              src="/images/publico_objetivo.jpg"
            ...
            <div className="md:ml-6 text-center md:text-left flex-1">
              ...
              <p className="text-gray-700">
                Trabajamos con estudiantes de carreras y programas TI de
                Educación Media y Postsecundaria. Enfocamos nuestra intervención
                en estudiantes vulnerables a la deserción.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center p-6 bg-white rounded-lg shadow-lg">
            ...
            <div className="md:ml-6 text-center md:text-left flex-1">
              ...
              <ul className="list-disc list-inside text-gray-700 space-y-2">
                ...
                <li>
                  Explorar modelos de intervención desde los colegios para
                  aportar a reducir la deserción en educación superior.
                </li>
                <li>
                ...
                <li>
                  Ayudar a reducir la deserción en otras universidades y
                  programas para afinar nuestro modelo y generar ingresos que
                  aporten a la sostenibilidad de la Fundación Antivirus.
                </li>
              </ul>
            </div>
          </div>
